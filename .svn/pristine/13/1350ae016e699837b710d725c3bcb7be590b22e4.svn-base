...
export class PdfReportService {
  ...
  addTable(tableList, startY, pdf, wrapperPdf){
      ...
      for(var idx in tableList){
          ...
          if (tableIdx == 0) {
              ...
              wrapperPdf.myText(table.title,{align: "center"}, 0, startY-5)
          } else {
              table.style['startY'] = pdf.autoTableEndPosY() + 40;
              wrapperPdf.myText(table.title,{align: "center"}, 0, pdf.autoTableEndPosY() + 25);
          }
