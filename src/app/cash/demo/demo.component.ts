...
@Component({
    ...
    animations: [
        trigger('toggleCollapse', [
            ...
            transition('* => *', animate('0.55s ease-in-out'))
        ])
    ]
})
export class DemoComponent implements OnInit, OnDestroy {
    ...
    constructor(private demoService: DemoService, private headerService: HeaderService, private titleService: TitleService) {
    ...
    ngOnInit() {
        this.titleService.setTitle('cash_demo');
        this.titleService.setMetaTags('cash_demo');
    ...
    scroll() {
        ...
        document.documentElement.scrollTop = this.myScrollContainer.nativeElement.offsetTop + 70;
    }
