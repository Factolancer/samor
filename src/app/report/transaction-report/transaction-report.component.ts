...
export class TransactionReportComponent implements OnInit, OnDestroy {
    ...
    startDownloadAfterLoad: boolean;
    /*for tos start download post data load in mobile view in single click*/
    className: string;

    constructor(private reportService: ReportService, public viewContainerRef: ViewContainerRef, private snackBarService: SnackBarService,
                public headerService: HeaderService, private dateAdapter: DateAdapter<Date>, private logger: Logger,
                public dialog: MdDialog, private transactionReportService: TransactionReportService, private utilityService: UtilityService) {
        ...
        this.className = "TransactionReportComponent";
    }
    ...
    filterTransactions() {
        ...
        transFilter.startDate = this.utilityService.getDateddMMyyyy(tempStartDate);
        transFilter.endDate = this.utilityService.getDateddMMyyyy(tempEndDate);
        transFilter.fundId = this.selectedFundId;
        ...
        if (!isNullOrUndefined(this.startDate) && !isNullOrUndefined(this.endDate != undefined)) {
            ...
            } else if (!this.isDateRangeValid(tempStartDate, tempEndDate)) {
